...
\textbf{Nome do QR Code}&\textbf{LF(\%)}&\textbf{LV(\%)}&\textbf{ EH(\%)}&\textbf{S(\%)}&\textbf{Método Ótimo} \\\hline
...
QR Code 13 & 34.76\% & 28.69\% & 28.83\% & 29.29\% & LV \\\hline
\end{tabular}%
}
\end{scriptsize}
\end{minipage}
...
QR Code 13 & 47.12\% & 51.13\% & 49.16\% & 49.05\% & LF \\\hline
\end{tabular}%
}
\end{scriptsize}
\end{minipage}
...
QR Code 13 & 49.12\% & 45.98\% & 44.43\% & 28.88\% & S \\\hline
\end{tabular}%
}
\end{scriptsize}
\end{minipage}
